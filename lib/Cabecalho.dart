                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Padding(padding: EdgeInsets.symmetric(horizontal: 4, vertical: 2), child: Text('Data do Plantão:*', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold))),
                              const SizedBox(height: 30),
                              Expanded(
                                child: TextField(
                                  decoration: InputDecoration(
                          ...
                          Row(
                            children: [
                              Padding(padding: EdgeInsets.symmetric(horizontal: 4, vertical: 2), child: Text('Horário Plantão:*', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold))),
                              const SizedBox(height: 30),
                              Expanded(
                                child: TextField(
                                  decoration: InputDecoration(
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.center, //centralizando os filhos
                                  children: [
                                    ElevatedButton(
                                      onPressed: null,
                                      child: const Text(
